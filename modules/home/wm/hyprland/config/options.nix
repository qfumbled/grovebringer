{ lib, ... }:
{
  wayland.windowManager.hyprland.settings = {
    exec-once = [
      "swaybg -i ~/grovebringer/home/shared/walls/girl7.jpeg -m fill"
      "clipse -listen"
    ...
    general = {
      ...
      "col.active_border" = lib.mkForce "rgba(88888888)";
      "col.inactive_border" = lib.mkForce "rgba(00000088)";
    ...
    group = {
      "col.border_inactive" = lib.mkForce "rgba(161616EE)";
      "col.border_active" = lib.mkForce "rgba(565656EE)";
    };
